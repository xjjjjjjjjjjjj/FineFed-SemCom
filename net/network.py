...
class WITT(nn.Module):
    def __init__(self, args, config, flag, i, j): 
        ...
        if flag == 1: #重组的一对编解码器
            state_dict1 = torch.load('C:/Users/徐静/Desktop/WITT/WITT_CPU_3.1/WITT_model/3.1/temp/net'+str(i)+'_encoder.model')
            self.encoder.load_state_dict(state_dict1)
            state_dict2 = torch.load('C:/Users/徐静/Desktop/WITT/WITT_CPU_3.1/WITT_model/3.1/temp/net'+str(j)+'_decoder.model')
